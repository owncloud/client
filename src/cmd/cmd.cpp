...
int main(int argc, char **argv)
{
    ...
    QEventLoop loop;
    JsonApiJob capabilitiesJob(account, QLatin1String("ocs/v1.php/cloud/capabilities"));
    QObject::connect(&capabilitiesJob, &JsonApiJob::jsonReceived, [&](const QJsonDocument &json) {
    ...
    JsonApiJob userJob(account, QLatin1String("ocs/v1.php/cloud/user"));
    QObject::connect(&userJob, &JsonApiJob::jsonReceived, [&](const QJsonDocument &json) {
