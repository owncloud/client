...
if(WITH_LIBCLOUDPROVIDERS)
  target_sources(owncloudCore PRIVATE libcloudproviders/libcloudproviders.cpp)
  target_link_libraries(owncloudCore PUBLIC PkgConfig::CLOUDPROVIDERS PkgConfig::GLIB2 PkgConfig::GIO)
  ...
  install(FILES ${CMAKE_CURRENT_BINARY_DIR}/${APPLICATION_CLOUDPROVIDERS_DBUS_NAME}.ini DESTINATION "${DATA_INSTALL_DIR}/cloud-providers")
