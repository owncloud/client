...
{
    if (!context->accountBuilder().classicWebFingerUsername().isEmpty()) {
        _page =
            BasicCredentialsSetupWizardPage::createForWebFinger(_context->accountBuilder().serverUrl(), _context->accountBuilder().classicWebFingerUsername());
    } else {
