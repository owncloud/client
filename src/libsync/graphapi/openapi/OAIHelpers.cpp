...
public:
    ...
    static CustomDateTimeFormat getCustomDateTimeFormat() { return getInstance()->customDateTimeFormat; }
...
{
    return QString::fromUtf8(value ? "true" : "false");
}
...
bool fromStringValue(const QString &inStr, bool &value)
{
    ...
    return ((inStr == QStringLiteral("true")) || (inStr == QStringLiteral("false")));
}
...
bool fromJsonValue(QString &value, const QJsonValue &jval)
{
    ...
    if (!jval.isUndefined() && !jval.isNull()) {
        if (jval.isString()) {
            ...
            value = jval.toBool() ? QStringLiteral("true") : QStringLiteral("false");
