Feature: Sharing
  ...
  Scenario: simple sharing
    ...
    And user 'Alice' has set up a client with these settings:
            ...
            version=2
            """
    When a file "textfile0.txt" is created locally with content "this is a test file"
    And the user adds "Brian" as collaborator of resource "%client_sync_path%/textfile0.txt" with permissions "edit,share" using the client-UI
