Feature: Syncing files
    ...
    Scenario: Syncing all files and folders from the server
        Given user "Alice" has created folder "simple-folder1" in the server
        ...
        And user "Alice" has created a folder "simple-folder1" inside the sync folder of branded client
    ...
    Scenario: Many subfolders can be synced
        ...
        And user "Alice" has set up a client with default settings
        And user "Alice" has created a folder "parent" inside the sync folder of branded client
    ...
    Scenario: Verify that you can create a subfolder with long name
        Given user "Alice" has created folder "Folder2" in the server
        And user "Alice" has set up a client with default settings
        And user "Alice" has created a folder "Folder2" inside the sync folder of branded client
    ...
    Scenario: Filenames that are rejected by the server are reported (Linux only)
        Given user "Alice" has created folder "Folder4" in the server
        And user "Alice" has set up a client with default settings
        And user "Alice" has created a folder "Folder4" inside the sync folder of branded client
    ...
    Scenario: Invalid system names are synced (Linux only)
        ...
        And user "Alice" has set up a client with default settings
        And user "Alice" has created a folder "CON" inside the sync folder of branded client
        And user "Alice" has created a folder "test%" inside the sync folder of branded client
        And user "Alice" has created a file "/PRN" with the following content inside the sync folder of branded client
            """
            server content
            """
        And user "Alice" has created a file "/foo%" with the following content inside the sync folder of branded client
            """
            server content
            """
