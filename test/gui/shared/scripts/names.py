...
disable_virtual_file_support_QMessageBox = {"type": "QMessageBox", "unnamed": 1, "visible": 1, "name": "DisableVFSMessageBox"}
...
add_Folder_Sync_Connection_OCC_FolderWizard = {"name":"AddFolderSyncWizard", "type": "OCC::FolderWizard", "unnamed": 1, "visible": 1}
...
confirm_Folder_Sync_Connection_Removal_QMessageBox = {"name":"ConfirmFolderSyncRemovalMessageBox", "type": "QMessageBox", "unnamed": 1, "visible": 1}
...
newAccountWizard_OCC_NewAccountWizard = {"name": "NewAccountWizard", "type": "OCC::NewAccountWizard", "visible": 1}
newAccountWizard_Enter_your_server_address_to_get_started_Your_web_browser_will_be_opened_to_complete_sign_in_QLabel = {"text": "Enter your server address to get started. Your web browser will be opened to complete sign in.", "type": "QLabel", "unnamed": 1, "visible": 1, "window": newAccountWizard_OCC_NewAccountWizard}
newAccountWizard_https_host_docker_internal_9200_signin_v1_identifier_authorize_response_type_codeclient_id_QLabel = {"text": "https://host.docker.internal:9200/signin/v1/identifier/_/authorize?response_type=codeclient_id…", "type": "QLabel", "unnamed": 1, "visible": 1, "window": welcome_to_ownCloud_OCC_NewAccountWizard}
newAccountWizard_Leave_this_screen_open_A_sign_in_prompt_will_appear_in_your_web_browser_to_connect_you_to_the_following_address_QLabel = {"text": "Leave this screen open. A sign in prompt will appear in your web browser to connect you to the following address.", "type": "QLabel", "unnamed": 1, "visible": 1, "window": welcome_to_ownCloud_OCC_NewAccountWizard}