...
mainWindow_OCC_MainWindow = {"name": "MainWindow", "type": "OCC::MainWindow", "visible": 1}
mainWindow_QMenu = {"type": "QMenu", "unnamed": 1, "visible": 1, "window": mainWindow_OCC_MainWindow}
mainWindow_tableView_QTableView = {"name": "_tableView", "type": "QTableView", "visible": 1, "window": mainWindow_OCC_MainWindow}
mainWindow_folderOptionsMenu_QMenu = {"name": "folderOptionsMenu", "type": "QMenu", "visible": 1, "window": mainWindow_OCC_MainWindow}
mainWindow_stackedWidget_QStackedWidget = {"name": "stackedWidget", "type": "QStackedWidget", "visible": 1, "window": mainWindow_OCC_MainWindow}
stackedWidget_accountFoldersTreeView_QTreeView_2 = {"container": mainWindow_stackedWidget_QStackedWidget, "name": "accountFoldersTreeView", "type": "QTreeView", "visible": 1}
stackedWidget_groupBox_QGroupBox_2 = {"container": mainWindow_stackedWidget_QStackedWidget, "name": "groupBox", "type": "QGroupBox", "visible": 1}
groupBox_quickWidget_OCC_QmlUtils_OCQuickWidget = {"container": stackedWidget_groupBox_QGroupBox_2, "name": "quickWidget", "type": "OCC::QmlUtils::OCQuickWidget", "visible": 1}
quickWidget_scrollView_ScrollView_2 = {"container": groupBox_quickWidget_OCC_QmlUtils_OCQuickWidget, "id": "scrollView", "type": "ScrollView", "unnamed": 1, "visible": True}
mainWindow_scrollArea_QScrollArea = {"name": "scrollArea", "type": "QScrollArea", "visible": 1, "window": mainWindow_OCC_MainWindow}
scrollArea_generalGroupBox_QGroupBox = {"container": mainWindow_scrollArea_QScrollArea, "name": "generalGroupBox", "type": "QGroupBox", "visible": 1}
scrollArea_advancedGroupBox_QGroupBox = {"container": mainWindow_scrollArea_QScrollArea, "name": "advancedGroupBox", "type": "QGroupBox", "visible": 1}
