...
IF( DEFINED CSYNC_BUILD_PATH )
  ...
  ENDIF()
ELSE()
  FIND_LIBRARY(CSYNC_LIBRARY NAMES ocsync HINTS $ENV{CSYNC_DIR} $ENV{CSYNC_LIB_DIR})
ENDIF()

IF(NOT DEFINED CSYNC_INCLUDE_PATH)
  FIND_PATH(CSYNC_INCLUDE_PATH NAMES csync.h HINTS $ENV{CSYNC_DIR} $ENV{CSYNC_INCLUDE_DIR})
ENDIF()
