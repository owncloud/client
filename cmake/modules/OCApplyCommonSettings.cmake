...
# common target settings that are used by all important targets not adding strict compile settings included in apply_common_target_settings
function(apply_common_target_settings_soft targetName)
  if(FORCE_ASSERTS)
    target_compile_definitions(${targetName} PRIVATE QT_FORCE_ASSERTS)
  endif()
endfunction()
